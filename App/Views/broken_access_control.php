...
<div class="bg-white p-6 rounded-lg shadow-md w-full max-w-lg">
    ...
    <ul class="list-disc list-inside space-y-2 text-gray-700">
        <li><code class="bg-gray-100 px-1.5 py-0.5 rounded text-sm">/login</code> (Trang đăng nhập)</li>
        <li><code class="bg-gray-100 px-1.5 py-0.5 rounded text-sm">/admin</code> (Trang quản trị)</li>
        <li><code class="bg-gray-100 px-1.5 py-0.5 rounded text-sm">/admin/posts</code> (Trang quản trị bài viết)</li>
        <li><code class="bg-gray-100 px-1.5 py-0.5 rounded text-sm">/admin/posts/store</code> (Tạo quản trị bài viết)</li>
    </ul>
</div>

<!-- Form kiểm tra -->
<div class="mt-6">
    <h3 class="text-lg font-semibold mb-4 text-center">Kiểm tra lỗ hổng</h3>
    <div class="bg-white p-6 rounded-md shadow-md">
        <form class="mb-4 relative"
              action="<?= url('/broken-access-control') ?>"
        >
            <div class="mb-4 relative">
            <label class="block text-sm font-medium text-gray-700 mb-1">Truy cập theo trang</label>
            ...
            <div class="mb-4 flex items-center">
                <label class="text-sm font-medium text-gray-700 mr-3">Bật có check quyền admin</label>
                <div class="relative inline-block w-10 h-6">
                    ...
                    <label
                            for="toggle"
                            class="block w-full h-full bg-gray-300 rounded-full cursor-pointer transition-colors duration-300 ease-in-out peer-checked:bg-blue-600"
                    >
                        <span
                                class="absolute left-1 top-1 w-4 h-4 bg-white rounded-full transition-transform duration-300 ease-in-out peer-checked:translate-x-4"
                        ></span>
                    </label>
                </div>
            </div>
        ...
        <div class="mt-4 p-4 rounded-md flex items-center">
           <iframe src="<?=url('/test'.$path)?>" class="w-full h-[500px]"></iframe>
        </div>
        <?php endif; ?>
    </div>
</div>